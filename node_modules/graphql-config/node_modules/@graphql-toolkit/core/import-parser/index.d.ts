 ...
 */
export declare function processImportSyntax(documentSource: Source, options: LoadTypedefsOptions): Promise<void>;
/**
 ...
 */
export declare function resolveModuleFilePath(filePath: string, importFrom: string, options: LoadTypedefsOptions): Promise<string>;
/**
 ...
 */
export declare function collectDefinitions(imports: string[], documentSource: Source, options: LoadTypedefsOptions): Promise<void>;
