...
var fbTest = require('@firebase/testing');
// serviceAccountKey.json can be generated in Firebase Console.
// const serviceAccountKey = require('./serviceAccountKey.json')
var seed = require('firestore-seed');
function test() {
    return __awaiter(this, void 0, void 0, function () {
        var dbURL, messagesCollection, db, docRef, users;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    fbTest.initializeAdminApp({
                        projectId: 'instamooddev'
                    });
                    messagesCollection = seed.collection('messages', [
                        seed.doc('message1', {
